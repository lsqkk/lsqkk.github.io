...
def generate_rss(posts_data):
    ...
    for post in latest_posts:
        ...
        # 创建内容（包含引用和文章正文）
        content_with_note = f"""<blockquote>This rendering was automatically generated by QuarkBlog and may have formatting issues. For the best experience, please visit: <a href="{post_url}">{post_url}</a></blockquote>{article_html}"""
